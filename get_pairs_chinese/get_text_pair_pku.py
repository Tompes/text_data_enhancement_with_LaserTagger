...
def process(corpus_folder, raw_file_name, save_folder):
    ...
    save_file = os.path.join(save_folder, "PKU.txt")
...
if __name__ == "__main__":
    corpus_folder = "D:\\0CODE\\text-rephrase\\text_data_enhancement_with_LaserTagger\data\PKU"
    raw_file_name = "paraphrase_unorder"
    save_folder = "D:\\0CODE\\text-rephrase\\text_data_enhancement_with_LaserTagger\data\PKU\PKU_PROCESSED"
